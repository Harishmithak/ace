        ...
        <div class="designer1 text-black">
            ...
            <div class="designer1 text-black">
                <div class="row bg-transprent justify-content-center">
                    <div class="col-12 text-center">
                        <p
                            class="ms-4 fw-normal fs-2"
                           style="margin-top: 270px; padding-bottom: 250px;"
                        >
...
<div class="girl">
    ...
    <div class="container">
                <div id="text2">
                    ...
                    <img src="http://cdn.storehippo.com/s/5997cc7c4d6e8ffa20e50aae/ms.files/BK,.jpg" alt='img' class="img-responsive" width="100%" />
                </div>
            </div>
</div>
